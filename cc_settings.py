...
class Settings:
    ...
    def __init__(self):
        ...
        self.lost_price = 50                    # loss contract price line
        ...
        self.profit_price = 70                   # profit contract price line
        ...
        self.volume_threshold = 80000      # when higher than this value starts making orders
